...
The following steps relate to all images:
 ...
 - Update the various .travis/build-deploy.sh scripts to correctly tag the images that are being built. (this will likley involve moving which image is tagged as latest)
